...
CMakeFiles/cscope:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/michele/OpenCog_ALL/cogserver/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating CScope database"
	cd /home/michele/OpenCog_ALL/cogserver && find opencog examples tests -name '*.cc' -o -name '*.h' -o -name '*.cxxtest' -o -name '*.scm' > /home/michele/OpenCog_ALL/cogserver/cscope.files
	cd /home/michele/OpenCog_ALL/cogserver && cscope -b
